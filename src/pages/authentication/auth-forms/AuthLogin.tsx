...
import { loginWithEmailAndPassword, loginWithGoogle } from '../../../controllers/firebase/auth';
        ...
        <>
            <Formik
                ...
                onSubmit={async ({ email, password }, { setErrors, setStatus, setSubmitting }) => {
                    try {
                        await loginWithEmailAndPassword({ email, password, notificationContext, authContext, navigate })
