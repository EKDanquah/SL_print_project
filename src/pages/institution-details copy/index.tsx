                                ...
                                department={
                                    {
                                        ...
                                        institutionID: 'kijbsdfkn-jskdf0-lskndkjnfd-iknsdjk'
                                    } as InstitutionDepartmentType
                                }
                            />
                        </Grid>
                    ))}
...
function DepartmentDialog({ department }: { department: InstitutionDepartmentType }) {
    const [open, setOpen] = useState<boolean>(false);
