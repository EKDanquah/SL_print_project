...
function ShadowBox({ shadow }: ShadowBoxPropTypes) {
    return (
...
type ShadowBoxPropTypes = {
    shadow: string
};

// ===============================|| CUSTOM - SHADOW BOX ||=============================== //

function CustomShadowBox({ shadow, label, color, bgcolor }: CustomShadowBoxPropTypes) {
    return (
